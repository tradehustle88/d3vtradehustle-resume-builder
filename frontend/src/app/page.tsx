  ...
  return (
    <div className="bg-[#0A0A0A] min-h-screen">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-950/20 via-transparent to-red-950/20" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-5xl lg:text-7xl font-black text-white mb-6 leading-tight">
                Get Past the Bots.
                <br />
                <span className="text-[#FFD700]" style={{textShadow: '0 0 30px rgba(255, 215, 0, 0.6)'}}>Impress the Recruiter.</span>
              </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all group">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Import from Indeed or Upload Yours</h3>
            <p className="text-gray-400 mb-4">Link your Indeed profile or drop a Word/PDF. We pull your info instantly—no retyping.</p>
            <p className="text-sm text-gray-500">One-click import • Word, PDF, or Indeed link</p>
          </div>

          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all group">
            <div className="w-16 h-16 bg-[#DC2626]/20 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform" style={{boxShadow: '0 0 20px rgba(220, 38, 38, 0.5)'}}>
              <svg className="w-8 h-8 text-[#DC2626]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="text-2xl font-bold text-white mb-3">Recruiter Bot Scores Your Resume</h3>
            <p className="text-gray-400 mb-4">Our Enhanced Intelligence plays recruiter. Get a real-time score + fixes for ATS systems and human hiring managers.</p>
            <p className="text-sm text-gray-500">See your score in 60 seconds</p>
          </div>

          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all group">
            <div className="w-16 h-16 bg-[#FFD700]/20 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform" style={{boxShadow: '0 0 30px rgba(255, 215, 0, 0.6)'}}>
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Trade-Specific Templates That Work</h3>
            <p className="text-gray-400 mb-4">12+ layouts tested with HVAC, electrical, plumbing, and construction recruiters. Pick one, we auto-fill the rest.</p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="flex flex-wrap justify-center items-center gap-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-1">ATS-Optimized</div>
              <div className="text-sm text-gray-400">Beats 92% of bots</div>
            </div>
            <div className="h-12 w-px bg-white/20" />
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-1">Recruiter Approved</div>
              <div className="text-sm text-gray-400">200+ hiring managers</div>
            </div>
            <div className="h-12 w-px bg-white/20" />
            <div className="text-center">
              <div className="text-3xl font-bold text-[#FFD700]" style={{textShadow: '0 0 20px rgba(255, 215, 0, 0.5)'}}>2,847 Hires</div>
              <div className="text-sm text-gray-400">Verified placements</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Testimonials */}
      <section className="max-w-7xl mx-auto px-6 py-24">
        <h2 className="text-4xl font-black text-white text-center mb-16">Built by Tradespeople. <span className="text-[#FFD700]">Backed by Results.</span></h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <div className="text-sm text-gray-400">Journeyman Electrician</div>
                <div className="text-xs text-gray-500">Chicago, IL</div>
              </div>
            </div>
            <p className="text-gray-300 italic">"Got 3 interview calls in the first week. The recruiter score nailed what was missing."</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <div className="font-bold text-white">Tasha Williams</div>
                <div className="text-sm text-gray-400">HVAC Technician</div>
                <div className="text-xs text-gray-500">Phoenix, AZ</div>
              </div>
            </div>
            <p className="text-gray-300 italic">"Imported from Indeed, fixed my bullets with Enhanced Intelligence, hired within 14 days at a union shop. $8/hr raise."</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <div className="font-bold text-white">Jake Ortiz</div>
                <div className="text-sm text-gray-400">Pipe Welder</div>
                <div className="text-xs text-gray-500">Houston, TX</div>
              </div>
            </div>
            <p className="text-gray-300 italic">"My old resume scored 34%. TradeHustle got me to 91% in 5 minutes."</p>
          </div>
        </div>
      </section>

      {/* CTA Section */}
      <section className="border-t border-white/10 bg-gradient-to-b from-transparent to-[#DC2626]/10">
        <div className="max-w-4xl mx-auto px-6 py-24 text-center">
          <h2 className="text-5xl font-black text-white mb-6">
            Your Data. <span className="text-[#FFD700]" style={{textShadow: '0 0 30px rgba(255, 215, 0, 0.6)'}}>Your Control.</span>
          </h2>
